const rawProjects = [
  {
    ...
    timeline: '4 Weeks',
    coverImage: '/projects/smell-food-mobile/Screenshot 2026-05-20 011704.png',
    slides: [
      { src: '/projects/smell-food-mobile/Screenshot 2026-05-20 011704.png', label: 'Food Feed View', frame: 'mac' },
      { src: '/projects/smell-food-mobile/Screenshot 2026-05-20 011804.png', label: 'Restaurant Listing', frame: 'mac' },
      { src: '/projects/smell-food-mobile/Screenshot 2026-05-20 011840.png', label: 'Item Detail & Cart', frame: 'mac' },
      { src: '/projects/smell-food-mobile/Screenshot 2026-05-20 011922.png', label: 'Checkout Summary', frame: 'mac' },
      { src: '/projects/smell-food-mobile/Screenshot 2026-05-20 012000.png', label: 'Order Confirmed', frame: 'mac' },
    ],
    metrics: [
  ...
  },
  {
    ...
    timeline: '6 Weeks',
    coverImage: '/projects/t-expo/Home Screen.png',
    slides: [
      { src: '/projects/t-expo/Home Screen.png', label: 'Discovery Feed', frame: 'mobile' },
      { src: '/projects/t-expo/Place details.png', label: 'Live Location Status', frame: 'mobile' },
      { src: '/projects/t-expo/Add details.png', label: 'Community Contribution', frame: 'mobile' },
      { src: '/projects/t-expo/Desktop wide mode.png', label: 'Desktop Adaptive', frame: 'mac' },
    ],
    metrics: [
